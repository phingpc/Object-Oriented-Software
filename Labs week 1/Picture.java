...
public class Picture
{
   ...
   public void print_house_color (){
       System.out.println("Roof color = "+roof.getColor()); 
       System.out.println("wall color = "+wall.getColor()); 
       System.out.println("sun color = "+sun.getColor()); 
       System.out.println("window color = "+window.getColor()); 
   }
   String getHouseColor(){
       if(wall.getColor() == "red"){
           return "red";
        } else if (wall.getColor() == "blue"){
            return "blue";
        } else {
            return "green";
        }
